...
public class repositoriesContent extends org.polarsys.kitalpha.doc.gen.business.core.doccontent.ElementDocContent {
	protected static String nl;

	public static synchronized repositoriesContent create(String lineSeparator) {
		nl = lineSeparator;
		repositoriesContent result = new repositoriesContent();
		nl = null;
		return result;
	}
	...
	public String generate(Object argument) throws Exception {
		...
		for (Object parameterParameter : parameterList) {
			...
			this.parameter = (org.polarsys.kitalpha.pdt.metamodel.model.platform.Repository) parameterParameter;
	...
	protected org.polarsys.kitalpha.pdt.metamodel.model.platform.Repository parameter = null;

	public void set_parameter(org.polarsys.kitalpha.pdt.metamodel.model.platform.Repository object) {
	...
	protected void method_content(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		String repoName = ((Repository) element).getName();
		if (repoName == null) {
			repoName = "Repository Name not found";
		}
