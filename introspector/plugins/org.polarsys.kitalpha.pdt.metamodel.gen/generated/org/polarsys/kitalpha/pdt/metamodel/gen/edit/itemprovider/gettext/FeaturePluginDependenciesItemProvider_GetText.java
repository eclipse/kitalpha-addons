...
public class FeaturePluginDependenciesItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized FeaturePluginDependenciesItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		FeaturePluginDependenciesItemProvider_GetText result = new FeaturePluginDependenciesItemProvider_GetText();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN" + NL + "\t\t **/" + NL + "" + NL
			+ "\t\treturn \"Plugin Dependencies\";" + NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL
			+ "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public FeaturePluginDependenciesItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("FeaturePluginDependencies");
	}
}