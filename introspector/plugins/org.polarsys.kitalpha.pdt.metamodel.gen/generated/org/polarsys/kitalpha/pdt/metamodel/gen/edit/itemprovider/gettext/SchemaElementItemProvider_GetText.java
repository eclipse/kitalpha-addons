...
public class SchemaElementItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized SchemaElementItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		SchemaElementItemProvider_GetText result = new SchemaElementItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN : []" + NL + "\t\t **/" + NL
			+ "\t\tString label = ((SchemaElement) object).getName();" + NL + "\t\tif(label != null)" + NL
			+ "\t\t\treturn label + \" [Schema Element]\";" + NL + "\t\telse " + NL
			+ "\t\t\treturn \"[Schema Element]\";" + NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL
			+ "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public SchemaElementItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("SchemaElement");
	}
}