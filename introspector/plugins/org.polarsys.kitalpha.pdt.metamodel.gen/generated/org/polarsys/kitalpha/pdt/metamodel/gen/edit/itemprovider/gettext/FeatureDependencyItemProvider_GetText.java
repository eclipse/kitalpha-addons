...
public class FeatureDependencyItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized FeatureDependencyItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		FeatureDependencyItemProvider_GetText result = new FeatureDependencyItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN" + NL + "\t\t **/" + NL
			...
			+ "\t\tFeatureDependency dependency = (FeatureDependency) object;" + NL + "" + NL
			...
			+ "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn label + \" [Feature Dependency]\";" + NL
			+ "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public FeatureDependencyItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("FeatureDependency");
	}
}