...
public class ExportedPackageItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized ExportedPackageItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		ExportedPackageItemProvider_GetText result = new ExportedPackageItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN" + NL + "\t\t **/" + NL
			+ "\t\t\tString label = ((ExportedPackage)object).getId();" + NL + "\t\t\treturn label;" + NL + "\t\t/**"
			+ NL + "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/";
	protected final String TEXT_2 = NL;

	public ExportedPackageItemProvider_GetText() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		genModel.addImport("org.polarsys.kitalpha.pdt.metamodel.model.platform.ExportedPackage");
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("ExportedPackage");
	}
}