...
public class ConfigurationElementAttributeItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized ConfigurationElementAttributeItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		ConfigurationElementAttributeItemProvider_GetText result = new ConfigurationElementAttributeItemProvider_GetText();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN : [ConfigurationElementAtributeItem]"
			+ NL + "\t\t **/" + NL + "\t\tString label = \"\";" + NL
			+ "\t\tConfigurationElementAttribute CEA = (ConfigurationElementAttribute) object;" + NL
			+ "\t\tlabel = \"\" + CEA.getName() + \" : \" + CEA.getType();" + NL + "\t\treturn label;" + NL + "\t\t/**"
			+ NL + "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public ConfigurationElementAttributeItemProvider_GetText() {
