...
public class PluginExtensionsItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized PluginExtensionsItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		PluginExtensionsItemProvider_GetText result = new PluginExtensionsItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN" + NL + "\t\t **/" + NL
			+ "\t\treturn \"Extensions\";" + NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/" + NL;
	protected final String TEXT_2 = NL;
	protected final String TEXT_3 = NL;

	public PluginExtensionsItemProvider_GetText() {
