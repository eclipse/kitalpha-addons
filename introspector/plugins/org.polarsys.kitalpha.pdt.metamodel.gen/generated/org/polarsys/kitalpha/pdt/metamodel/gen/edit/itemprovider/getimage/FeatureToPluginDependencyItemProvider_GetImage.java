...
public class FeatureToPluginDependencyItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized FeatureToPluginDependencyItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		FeatureToPluginDependencyItemProvider_GetImage result = new FeatureToPluginDependencyItemProvider_GetImage();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "\t\t" + NL + "@Override" + NL
			+ "public Object overlayImage(Object object, Object image){" + NL + "\t\t/**" + NL
			+ "\t\t * CUSTOM_CODE_BEGIN : []" + NL + "\t\t **/" + NL
			+ "\t\treturn super.overlayImage(object, getResourceLocator().getImage(\"full/obj16/PluginDependency\"));"
			+ NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/" + NL + "}";
	protected final String TEXT_2 = NL;

	public FeatureToPluginDependencyItemProvider_GetImage() {
