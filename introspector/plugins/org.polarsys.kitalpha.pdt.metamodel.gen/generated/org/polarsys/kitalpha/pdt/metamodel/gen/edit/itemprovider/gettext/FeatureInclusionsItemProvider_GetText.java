...
public class FeatureInclusionsItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized FeatureInclusionsItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		FeatureInclusionsItemProvider_GetText result = new FeatureInclusionsItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN" + NL + "\t\t **/" + NL
			+ "\t\t\treturn \"Included Features\";" + NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL
			+ "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public FeatureInclusionsItemProvider_GetText() {
