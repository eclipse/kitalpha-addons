...
public class StringValueItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized StringValueItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		StringValueItemProvider_GetText result = new StringValueItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN : []" + NL + "\t\t **/" + NL
			+ "\t\tString label = ((StringValue) object).getValue();" + NL + "\t\tif(label != null)" + NL
			+ "\t\t\treturn \"Value = \" + label;" + NL + "\t\telse " + NL + "\t\t\treturn \"Value = \";" + NL
			+ "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/" + NL;
	protected final String TEXT_2 = NL;
	protected final String TEXT_3 = NL;

	public StringValueItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("StringValue");
	}
}