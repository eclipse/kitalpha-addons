...
public class PluginExtensionsItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized PluginExtensionsItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		PluginExtensionsItemProvider_GetImage result = new PluginExtensionsItemProvider_GetImage();
		nl = null;
		return result;
	}
	...
	public PluginExtensionsItemProvider_GetImage() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("PluginExtensions");
	}
}