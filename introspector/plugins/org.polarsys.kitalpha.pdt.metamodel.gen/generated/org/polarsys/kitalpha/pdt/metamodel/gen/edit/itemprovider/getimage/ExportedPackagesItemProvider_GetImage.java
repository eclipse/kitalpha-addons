...
public class ExportedPackagesItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized ExportedPackagesItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		ExportedPackagesItemProvider_GetImage result = new ExportedPackagesItemProvider_GetImage();
		nl = null;
		return result;
	}
	...
	public ExportedPackagesItemProvider_GetImage() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("ExportedPackages");
	}
}