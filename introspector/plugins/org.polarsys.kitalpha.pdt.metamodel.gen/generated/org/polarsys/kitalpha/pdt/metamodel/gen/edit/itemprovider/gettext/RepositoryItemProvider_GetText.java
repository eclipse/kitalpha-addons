...
public class RepositoryItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized RepositoryItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		RepositoryItemProvider_GetText result = new RepositoryItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN" + NL + "\t\t **/" + NL + "" + NL
			+ "\t\tString label = ((Repository)object).getName();" + NL + "\t\treturn label;" + NL + "\t\t/**" + NL
			+ "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public RepositoryItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("Repository");
	}
}