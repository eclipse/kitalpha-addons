...
public class PackageItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized PackageItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		PackageItemProvider_GetText result = new PackageItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = NL
			+ "\tString label = ((org.polarsys.kitalpha.pdt.metamodel.model.platform.Package)object).getName();" + NL
			+ "\t\treturn label;";
	protected final String TEXT_2 = NL;

	public PackageItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("Package");
	}
}