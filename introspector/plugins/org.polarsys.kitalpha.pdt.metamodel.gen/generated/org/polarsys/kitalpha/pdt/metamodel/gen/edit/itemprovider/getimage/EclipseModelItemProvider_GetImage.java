...
public class EclipseModelItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized EclipseModelItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		EclipseModelItemProvider_GetImage result = new EclipseModelItemProvider_GetImage();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "@Override" + NL + "\tpublic Object overlayImage(Object object, Object image) {"
			+ NL + "\t\treturn super.overlayImage(object, getResourceLocator().getImage(\"full/obj16/Platform\"));" + NL
			+ "\t}" + NL;
	protected final String TEXT_2 = NL;

	public EclipseModelItemProvider_GetImage() {
