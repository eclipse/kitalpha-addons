...
public class IncludedFeatureItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized IncludedFeatureItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		IncludedFeatureItemProvider_GetImage result = new IncludedFeatureItemProvider_GetImage();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "@Override" + NL + "\tpublic Object overlayImage(Object object, Object image) {"
			+ NL + "\t\treturn super.overlayImage(object, getResourceLocator().getImage(\"full/obj16/Feature\"));" + NL
			+ "\t}";
	protected final String TEXT_2 = NL;

	public IncludedFeatureItemProvider_GetImage() {
