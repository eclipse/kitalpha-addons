...
public class IncludedPluginsItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized IncludedPluginsItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		IncludedPluginsItemProvider_GetImage result = new IncludedPluginsItemProvider_GetImage();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "@Override" + NL + "\tpublic Object overlayImage(Object object, Object image) {"
			+ NL + "\t\treturn super.overlayImage(object, getResourceLocator().getImage(\"full/obj16/FolderPlugins\"));"
			+ NL + "\t}" + NL;
	protected final String TEXT_2 = NL;
	protected final String TEXT_3 = NL;

	public IncludedPluginsItemProvider_GetImage() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("IncludedPlugins");
	}
}