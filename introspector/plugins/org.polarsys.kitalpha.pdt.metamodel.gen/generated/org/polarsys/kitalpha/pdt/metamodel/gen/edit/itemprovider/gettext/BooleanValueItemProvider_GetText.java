...
public class BooleanValueItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized BooleanValueItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		BooleanValueItemProvider_GetText result = new BooleanValueItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN : []" + NL + "\t\t **/" + NL
			+ "\t\tBooleanValue booleanValue = (BooleanValue) object;" + NL
			+ "\t\treturn \"Value = \" + booleanValue.isValue();" + NL + "\t\t/**" + NL + "\t\t * CUSTOM_CODE_END : []"
			+ NL + "\t\t **/" + NL;
	protected final String TEXT_2 = NL;

	public BooleanValueItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("BooleanValue");
	}
}