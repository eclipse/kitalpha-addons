...
public class FeatureItemProvider_GetText
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProvidergetTextoverride {
	protected static String nl;

	public static synchronized FeatureItemProvider_GetText create(String lineSeparator) {
		nl = lineSeparator;
		FeatureItemProvider_GetText result = new FeatureItemProvider_GetText();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_1 = "\t\t/**" + NL + "\t\t * CUSTOM_CODE_BEGIN : []" + NL + "\t\t **/" + NL
			+ "\t\tString label = ((Feature) object).getId();" + NL + "\t\tif(label != null)" + NL
			+ "\t\t\treturn label + \" [Feature]\";" + NL + "\t\telse return \" [Feature]\";" + NL + "\t\t/**" + NL
			+ "\t\t * CUSTOM_CODE_END : []" + NL + "\t\t **/";
	protected final String TEXT_2 = NL;

	public FeatureItemProvider_GetText() {
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return genClass.getName().equals("Feature");
	}
}