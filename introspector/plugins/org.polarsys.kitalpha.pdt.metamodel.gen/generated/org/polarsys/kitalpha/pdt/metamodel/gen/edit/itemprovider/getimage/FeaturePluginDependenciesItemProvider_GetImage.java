...
public class FeaturePluginDependenciesItemProvider_GetImage
		extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
	protected static String nl;

	public static synchronized FeaturePluginDependenciesItemProvider_GetImage create(String lineSeparator) {
		nl = lineSeparator;
		FeaturePluginDependenciesItemProvider_GetImage result = new FeaturePluginDependenciesItemProvider_GetImage();
		nl = null;
		return result;
	}
	...
	public FeaturePluginDependenciesItemProvider_GetImage() {
